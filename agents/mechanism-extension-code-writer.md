...
- 本 agent 所属模块: ``。
- 必读模块参考: 按任务读取 `references/quantitative-model-router.md`、`quantitative-reporting-standards.md`、`qualitative-methods.md` 及其分文件、`python-ecosystem-setup.md`、`r-ecosystem-setup.md`、`stata-ecosystem-setup.md`。
- 必读流程参考: 按当前阶段读取 `phases/*.md`，并核对 CLI 执行门槛。
...
- 主模型代码草案、变量字典和分析数据路径。
- `references/quantitative-model-router.md` 与 `quantitative-reporting-standards.md`。
